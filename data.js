...
const PROJECTS = [
  { name: "Panchratna", area: "Opera House", year: 1971, size: "4,00,000 sq ft", status: "completed", flagship: true, note: "The firm's founding and flagship project — where it all started, in 1971.", photo: "img/panchratna.jpg" },
  { name: "Ridge Apartments", area: "Malabar Hill", year: 1975, size: "40,000 sq ft", status: "completed", note: "One of the firm's early landmark residential blocks, following soon after Panchratna.", photo: "img/ridge.jpg" },
  ...
  { name: "Odeon Apartments", area: "Girgaon", year: 1973, size: "30,000 sq ft", status: "completed", note: "Residential block raised beside the theatre, shops at street level.", photo: "img/odeon.jpg" },
  ...
  { name: "Pleasant Park", area: "Mumbai", year: 1995, size: "1,50,000 sq ft", status: "completed", note: "A green-courtyard residential enclave.", photo: "img/pleasant-park.jpg" },
  ...
  { name: "Raj Vihar", area: "Mumbai", year: 2024, size: "30,000 sq ft", status: "completed", jv: true, note: "Completed in 2024, developed in joint venture — part of the firm's ongoing Mumbai portfolio.", photo: "img/raj-vihar.jpg" },
  { name: "Emperia C2", area: "Mumbai", year: 2026, size: "12,50,000 sq ft", status: "ongoing", jv: true, completionTarget: "Dec 2028", note: "Our flagship current development, delivered in joint venture — the largest project in company history, targeted for completion by December 2028.", photo: "img/emperia-c2.jpg" },
];
...
const PARTNERS = [
  ...
  { name: "Shri Abhinav Gupta", role: "Partner", photo: "img/abhinav-gupta.jpg", bio: "Part of the current generation of leadership carrying the firm's projects forward across Mumbai." },
