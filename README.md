...
This is an ***extension exercise***. Extension exercises either include extra
challenges, or additional learning that goes beyond the scope of COMP1010's
examinable content. You don't need to attempt extension exercises, but we
encourage you to try any that are interesting to you or relevant to your
project.

With most extension exercises, we expect a little more self-directed learning
from you. While we're still happy to help, we encourage you to try to answer
your own questions before you ask us.

Remember, partial marks are awarded for partial solutions, so even if you can't
complete the entire task, it's still worth showing your tutor.
